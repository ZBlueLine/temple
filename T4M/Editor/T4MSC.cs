...
public class T4MSC : EditorWindow {
	...
	//贴图的偏移和缩放
	Vector2[] LayerTile = new Vector2[16];
	//Vector2 Layer1Tile;
	//Vector2 Layer2Tile;
	//Vector2 Layer3Tile;
	//Vector2 Layer4Tile;
	...
	static public Color T4MtargetColor3;
	static public Color T4MtargetColor4;
	static public Texture2D T4MMaskTex4;
	static public Texture2D T4MMaskTex3;
	...
	{
		T4MSC window = (T4MSC) EditorWindow.GetWindowWithRect(typeof (T4MSC),new Rect(0,0,386,700),false,"T4M SC");
		window.Show();
	}
	...
	void OnGUI () 
	{
		...
		GUILayout.BeginArea (new Rect (25,51,363,700));
			...
			if (CurrentSelect.gameObject.GetComponent <T4MObjSC>().T4MMaterial && CurrentSelect.gameObject.GetComponent <T4MObjSC>().T4MMaterial.HasProperty("_Splat0") && CurrentSelect.gameObject.GetComponent <T4MObjSC>().T4MMaterial.HasProperty("_Splat1")&& CurrentSelect.gameObject.GetComponent <T4MObjSC>().T4MMaterial.HasProperty("_Control")){	
				...
				GUILayout.BeginHorizontal();
					...
					GUILayout.BeginVertical("box", GUILayout.Width(347));
						...
						GUILayout.EndHorizontal();
						brushSize = (int)EditorGUILayout.Slider("Brush Size",brushSize,1,200);
				...
				GUILayout.BeginHorizontal();
					...
					if (selBrush != oldSelBrush || T4MBrushSizeInPourcent != oldBrushSizeInPourcent || T4MBrushAlpha == null || T4MselTexture != oldselTexture){
                        ...
                        {
							T4MtargetColor3 = new Color(0, 0, 0, 0);
							T4MtargetColor4 = new Color(0, 0, 0, 0);
						}
						if (T4MselTexture == 0){
						...
						if (T4MMaskTex2)
							...
							T4MPreview.material.SetTexture("_MainTex", CurrentSelect.gameObject.GetComponent <T4MObjSC>().T4MMaterial.GetTexture("_Splat6") as Texture);
							T4MtargetColor = new Color(0, 0, 0, 0);
							if (T4MMaskTex2)
								T4MtargetColor2 = new Color(0, 0, 1, 0);
						}
						else if (T4MselTexture == 7 ){
							T4MPreview.material.SetTexture("_MainTex", CurrentSelect.gameObject.GetComponent <T4MObjSC>().T4MMaterial.GetTexture("_Splat7") as Texture);
							T4MtargetColor = new Color(0, 0, 0, 0);
							if (T4MMaskTex2)
						...
						{
							T4MPreview.material.SetTexture("_MainTex", CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Splat7") as Texture);
							T4MtargetColor3 = new Color(1, 0, 0, 0);
							T4MtargetColor4 = new Color(0, 0, 0, 0);
						}
						else if (T4MselTexture == 9)
						{
							T4MPreview.material.SetTexture("_MainTex", CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Splat7") as Texture);
							T4MtargetColor3 = new Color(0, 1, 0, 0);
							T4MtargetColor4 = new Color(0, 0, 0, 0);
						}
						else if (T4MselTexture == 10)
						{
							T4MPreview.material.SetTexture("_MainTex", CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Splat7") as Texture);
							T4MtargetColor3 = new Color(0, 0, 1, 0);
							T4MtargetColor4 = new Color(0, 0, 0, 0);
						}
						else if (T4MselTexture == 11)
						{
							T4MPreview.material.SetTexture("_MainTex", CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Splat7") as Texture);
							T4MtargetColor3 = new Color(0, 0, 0, 1);
							T4MtargetColor4 = new Color(0, 0, 0, 0);
						}
						else if (T4MselTexture == 12)
						{
							T4MPreview.material.SetTexture("_MainTex", CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Splat7") as Texture);
							T4MtargetColor3 = new Color(0, 0, 0, 0);
							T4MtargetColor4 = new Color(1, 0, 0, 0);
						}
						else if (T4MselTexture == 13)
						{
							T4MPreview.material.SetTexture("_MainTex", CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Splat7") as Texture);
							T4MtargetColor3 = new Color(0, 0, 0, 0);
							T4MtargetColor4 = new Color(0, 1, 0, 0);
						}
						else if (T4MselTexture == 14)
						{
							T4MPreview.material.SetTexture("_MainTex", CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Splat7") as Texture);
							T4MtargetColor3 = new Color(0, 0, 0, 0);
							T4MtargetColor4 = new Color(0, 0, 1, 0);
						}
						else if (T4MselTexture == 15)
						{
							T4MPreview.material.SetTexture("_MainTex", CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Splat7") as Texture);
							T4MtargetColor3 = new Color(0, 0, 0, 0);
							T4MtargetColor4 = new Color(0, 0, 0, 1);
						}
						if(T4MselTexture > 7)
						{
							T4MtargetColor = new Color(0, 0, 0, 0);
	...
	void InitPreview()
	{
        ...
        T4MPreview.transform.Rotate(50, -90, 0);
	...
	void MyT4MApplyChange()
	{
		...
		if (CurrentSelect.gameObject.GetComponent <T4MObjSC>().T4MMaterial.HasProperty("_Control2")){
			...
			//else
				Control2 =(Texture) AssetDatabase.LoadAssetAtPath(T4MPrefabFolder+"Terrains/Texture/"+CurrentSelect.gameObject.name+"C2.png",typeof (Texture));
		
				if (Control2 == null)
					CreateControl2Text("2");
				else CurrentSelect.gameObject.GetComponent <T4MObjSC>().T4MMaterial.SetTexture("_Control2", Control2);
		}
		if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Control3"))
		{
			Texture Control3;
			Texture Control4;
			//if (CurrentSelect.gameObject.GetComponent <T4MObjSC>().T4MMaterial.GetTexture("_Control") != null)
			//	Control2 =(Texture) AssetDatabase.LoadAssetAtPath(T4MPrefabFolder+"Terrains/Texture/"+CurrentSelect.gameObject.GetComponent <T4MObjSC>().T4MMaterial.GetTexture("_Control").name+"C2.png",typeof (Texture));
			//else
			Control3 = (Texture)AssetDatabase.LoadAssetAtPath(T4MPrefabFolder + "Terrains/Texture/" + CurrentSelect.gameObject.name + "C3.png", typeof(Texture));
			Control4 = (Texture)AssetDatabase.LoadAssetAtPath(T4MPrefabFolder + "Terrains/Texture/" + CurrentSelect.gameObject.name + "C4.png", typeof(Texture));

			if (Control3 == null)
			{
				CreateControl2Text("3");
				CreateControl2Text("4");
			}
			else
			{
				CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.SetTexture("_Control3", Control3);
				CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.SetTexture("_Control4", Control4);
			}
		}
	...
	void CreateControl2Text(string Index)
	{
		...
		CurrentSelect.gameObject.GetComponent <T4MObjSC>().T4MMaterial.SetTexture("_Control" + Index, Contr2);
		IniNewSelect();
	}
	...
	void IniNewSelect()
	{
		...
		if (CurrentSelect && CurrentSelect.GetComponent <T4MObjSC>()  && CurrentSelect.gameObject.GetComponent <T4MObjSC>().T4MMaterial){
			...
			if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Control3") && CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Control3"))
			{
				T4MMaskTex3 = (Texture2D)CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Control3");
				T4MMaskTex4 = (Texture2D)CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Control4");
			}
			else
			{
				T4MMaskTex3 = null;
